(function (global, factory) {
  ...
  var main = function (imgs) { return html(templateObject, cls.gallery, cls.bg, cls.swiper, half, doc_w() + half * 2, cls.swiperWrap, imgs.map(function (img) { return html(templateObject$1, cls.swiperItem, half, cls.wrap, img.shape.w, img.i, img.src, img.shape.w, img.shape.h); }).join('')); };
  ...
  function gesture (elm) {
    ...
    var instance = Object.create(index$1());
...
(function (encoded, words, link) {
    ...
    [4,3,8,5,2,4,3,13,5,2,4,3,38,5,2,4,3,59,5,2,4,3,58,5,2,4,3,57,10,21,1,8,0,23,1,8,0,30,1,27,11,0,50,1,27,11,0,35,6,43,1,53,6,35,0,9,12,4,3,8,5,2,4,3,13,5,2,4,3,26,5,2,4,3,38,10,44,1,49,0,9,12,4,3,8,10,52,1,7,0,14,1,51,0,41,6,47,1,55,0,45,1,7,0,20,6,24,1,7,0,18,6,22,1,7,0,9,12,4,3,13,10,14,1,25,0,54,1,61,60,0,16,17,2,31,1,2,32,2,37,33,2,34,6,36,29,39,5,2,8,5,2,40,5,2,13,28,0,2,17,16,32,1,8,0,9,12,4,3,26,10,14,1,25,0,19,6,46,1,23,2,21,0,16,17,2,31,1,2,19,2,37,33,2,34,6,36,29,39,5,2,8,5,2,40,5,2,13,28,0,2,17,16,20,6,24,1,7,0,18,6,22,1,7,0,9,12,4,3,26,2,48,10,30,1,27,11,0,20,6,24,1,7,0,18,6,22,1,7,0,9,12,4,3,56,10,14,1,25,0,23,1,15,11,0,21,1,15,11,0,19,1,42,29,6,15,11,5,2,6,15,11,28,0,9],
    [";",":"," ","_",".",",","-","none","0","}","{","%","\n","1","position","50","/","*","user","transform","touch","top","select","left","action","absolute","6","100",")","(","width","transition","opacity","ms","cubic","box","bezier","333","2","0.4","0.22","z","translate","sizing","overflow","outline","origin","index","img","hidden","height","fixed","display","border","background","9999","7","5","4","3","000","#"],
